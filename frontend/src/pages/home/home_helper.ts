/**
 * This file contains helper functions for the Home page.
 * Adds basic user interaction to the Home page.
 * 
 * @author Atul
 * @version 1.0

*/
export default function home_helper() {
  /*==================== SHOW MENU ====================*/
