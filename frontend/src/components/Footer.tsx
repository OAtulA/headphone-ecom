...
import { RiMailSendLine, RiFacebookCircleFill, RiInstagramLine, RiTwitterLine } from 'react-icons/ri';
  ...
  return (
    <footer className="footer section">
      <div className="footer__container container grid">
        ...
        <div className="footer__content">
          ...
          <ul className="footer__links">
            ...
            <li><a href="#" className="footer__link">Register</a></li>
            <li><a href="#" className="footer__link">Updates</a></li>
            <li><a href="#" className="footer__link">Provides</a></li>
          </ul>
        </div>
      ...
      <p className="footer__copy">
        <a href="https://github.com/OAtulA" target="_blank" className="footer__copy-link">
